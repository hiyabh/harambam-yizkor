...
### Fixed (תוקן)
- שם קובץ ה-Word המורד מכיל גרשיים עבריות (תשפ״ז) במקום קו תחתון שהדפדפן הכניס במקום המרכאות - [export.js](js/export.js)

## [1.2.0] - 2026-09-19

### Changed (שונה)
- החיפוש סורק את כל הרשימה - גברים, נשים והשמות שנוספו השנה - ומציג תוצאות מקובצות תחת "גברים" / "נשים"; לשוניות המגדר מוסתרות בזמן חיפוש - [app.js](js/app.js)
- כפתור "הוסף את השם" במצב ללא תוצאות בוחר "נפטרת" אוטומטית כשהחיפוש מכיל "בת"
